# Any changes to the bin_gaus_etc_distribution library should be reinstalled with
#  pip install --upgrade .
...
class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        self.gaussian_one = Gaussian(25, 2)
        self.gaussian=Gaussian()
        self.gaussian.read_data_file("C:\\Users\\maata\\Udacity\\files\\numbers.txt")

    def test_initialization(self): 
        self.assertEqual(self.gaussian_one.mean, 25, 'incorrect mean')
        self.assertEqual(self.gaussian_one.stdev, 2, 'incorrect standard deviation')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial_one = Binomial()
        self.binomial_one.replace_stats_with_data("C:\\Users\\maata\\Udacity\\files\\numbers_binomial.txt")
    ...
    def test_readdata(self):
        self.assertEqual(self.binomial_one.data,\
    ...
    def test_replace_stats_with_data(self):
        p, n = self.binomial.replace_stats_with_data("C:\\Users\\maata\\Udacity\\files\\numbers_binomial.txt")
    ...
    def test_pdf(self):
        ...
        self.binomial.replace_stats_with_data("C:\\Users\\maata\\Udacity\\files\\numbers_binomial.txt")
...
class TestPoissonClass(unittest.TestCase):
    def setUp(self):
        self.poisson=Poisson(4)

    def test_initialization(self):
        self.assertEqual(self.poisson.lamda,  4, 'lamda value incorrect')    

    def test_pdf(self):
        self.assertEqual(round(self.poisson.pdf(6), 5), 0.1042)
        self.assertEqual(round(self.poisson.pdf(4), 5), 0.19537)  

    def test_add(self):
        poisson_one=Poisson(3)
        poisson_two=Poisson(4)  
        poisson_sum=poisson_one + poisson_two

        self.assertEqual(poisson_sum.lamda, 7)
